...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                .cors().configurationSource(corsConfigurationSource()).and() // CORS(Cross-Origin Resource Sharing) 활성화
                .authorizeRequests() // 권한 설정 시작
                .antMatchers("/**").permitAll()
                .antMatchers("/users/**").authenticated() // /users/** 요청에 대해 인증 필요
                ...
                .and()
                .addFilterBefore(new JwtTokenFilter(authService, secretKey), UsernamePasswordAuthenticationFilter.class) // JWT 토큰 필터 추가
                .build();
